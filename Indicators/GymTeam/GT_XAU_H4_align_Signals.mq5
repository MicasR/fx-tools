//+------------------------------------------------------------------+
//| GT_XAU_H4_align_Signals.mq5 — where the GymTeam king would trade        |
//| Leg: XAU_H4_align  ·  module: SIG_MA_ALIGN  ·  entry TF: PERIOD_H4                |
//| MA-alignment impulse: close beyond a rising/falling SMA50, SMA10 agreeing, bar range > 1.2x ATR14
//| Defaults = the live preset (presets/XAU_H4_align.set). Attach to the    |
//| leg's chart on its entry TF. Docs: XAU_H4_align_Signals.md              |
...
#property description "XAU_H4_align: MA-alignment impulse: close beyond a rising/falling SMA50, SMA10 agreeing, bar range > 1.2x ATR14"
...
input string             InpLegName    = "XAU_H4_align";     // Leg (stats panel label)
input ENUM_GT_SIGNAL     InpSignal     = SIG_MA_ALIGN;       // Signal module (preset)
input ENUM_TIMEFRAMES    InpEntryTF    = PERIOD_H4;        // Preset entry TF (chart should match)
