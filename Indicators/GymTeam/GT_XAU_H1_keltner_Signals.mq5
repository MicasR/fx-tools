//+------------------------------------------------------------------+
//| GT_XAU_H1_keltner_Signals.mq5 — where the GymTeam king would trade        |
//| Leg: XAU_H1_keltner  ·  module: SIG_KELTNER  ·  entry TF: PERIOD_H1                |
//| Keltner break: H1 close crosses out of EMA20 +/- 2.0x ATR14 (fresh edge, either side)
//| Defaults = the live preset (presets/XAU_H1_keltner.set). Attach to the    |
//| leg's chart on its entry TF. Docs: XAU_H1_keltner_Signals.md              |
...
#property description "XAU_H1_keltner: Keltner break: H1 close crosses out of EMA20 +/- 2.0x ATR14 (fresh edge, either side)"
...
input string             InpLegName    = "XAU_H1_keltner";     // Leg (stats panel label)
