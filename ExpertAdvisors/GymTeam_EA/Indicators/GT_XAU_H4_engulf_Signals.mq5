//+------------------------------------------------------------------+
//| GT_XAU_H4_engulf_Signals.mq5 — where the GymTeam king would trade        |
//| Leg: XAU_H4_engulf  ·  module: SIG_ENGULF  ·  entry TF: PERIOD_H4                |
//| Engulfing bar: H4 body engulfs the prior opposite body (both directions)
//| Defaults = the live preset (presets/XAU_H4_engulf.set). Attach to the    |
//| leg's chart on its entry TF. Docs: XAU_H4_engulf_Signals.md              |
...
#property description "XAU_H4_engulf: Engulfing bar: H4 body engulfs the prior opposite body (both directions)"
...
input string             InpLegName    = "XAU_H4_engulf";     // Leg (stats panel label)
input ENUM_GT_SIGNAL     InpSignal     = SIG_ENGULF;       // Signal module (preset)
