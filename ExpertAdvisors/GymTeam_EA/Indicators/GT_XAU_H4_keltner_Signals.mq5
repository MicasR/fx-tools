//+------------------------------------------------------------------+
//| GT_XAU_H4_keltner_Signals.mq5 — where the GymTeam king would trade        |
//| Leg: XAU_H4_keltner  ·  module: SIG_KELTNER  ·  entry TF: PERIOD_H4                |
//| Keltner break: H4 close crosses out of EMA20 +/- 2.0x ATR14 (fresh edge, either side)
//| Defaults = the live preset (presets/XAU_H4_keltner.set). Attach to the    |
//| leg's chart on its entry TF. Docs: XAU_H4_keltner_Signals.md              |
...
#property description "XAU_H4_keltner: Keltner break: H4 close crosses out of EMA20 +/- 2.0x ATR14 (fresh edge, either side)"
...
input string             InpLegName    = "XAU_H4_keltner";     // Leg (stats panel label)
input ENUM_GT_SIGNAL     InpSignal     = SIG_KELTNER;       // Signal module (preset)
