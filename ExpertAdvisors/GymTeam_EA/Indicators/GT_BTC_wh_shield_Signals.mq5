//+------------------------------------------------------------------+
//| GT_BTC_wh_shield_Signals.mq5 — where the GymTeam king would trade        |
//| Leg: BTC_wh_shield  ·  module: SIG_WARMHOURS  ·  entry TF: PERIOD_H1                |
//| Warm-volume hours: 2 rising H1 tick-volume bars, volume pct-rank in (80,98] of 100, hour in 12-16
//| Defaults = the live preset (presets/BTC_wh_shield.set). Attach to the    |
//| leg's chart on its entry TF. Docs: BTC_wh_shield_Signals.md              |
...
#property description "BTC_wh_shield: Warm-volume hours: 2 rising H1 tick-volume bars, volume pct-rank in (80,98] of 100, hour in 12-16"
...
input string             InpLegName    = "BTC_wh_shield";     // Leg (stats panel label)
input ENUM_GT_SIGNAL     InpSignal     = SIG_WARMHOURS;       // Signal module (preset)
...
input double             InpTpR        = 2.0;       // Fixed TP in R (0 = none)
